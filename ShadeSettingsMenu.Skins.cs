...
public static partial class ShadeSettingsMenu
{
    ...
    private static void BuildSkinsMenu(UIManager ui, MenuScreen ms, MenuButton buttonTemplate)
    {
        ...
        {
            var fallbackMessage = new GameObject("SkinsUnavailable");
            ...
            messageText.text = "No shade skins found.";
