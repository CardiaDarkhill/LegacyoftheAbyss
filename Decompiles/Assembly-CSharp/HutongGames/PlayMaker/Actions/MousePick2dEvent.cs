...
namespace HutongGames.PlayMaker.Actions
{
	...
	{
		// Token: 0x06006FA6 RID: 28582 RVA: 0x00228334 File Offset: 0x00226534
		...
		// Token: 0x06006FA7 RID: 28583 RVA: 0x00228383 File Offset: 0x00226583
		...
		// Token: 0x06006FA8 RID: 28584 RVA: 0x00228399 File Offset: 0x00226599
		public override void OnUpdate()
		{
			this.DoMousePickEvent();
		}

		// Token: 0x06006FA9 RID: 28585 RVA: 0x002283A4 File Offset: 0x002265A4
		...
		// Token: 0x06006FAA RID: 28586 RVA: 0x00228430 File Offset: 0x00226630
		private bool DoRaycast()
		{
			GameObject y = (this.GameObject.OwnerOption == OwnerDefaultOption.UseOwner) ? base.Owner : this.GameObject.GameObject.Value;
			RaycastHit2D rayIntersection = Physics2D.GetRayIntersection(Camera.main.ScreenPointToRay(ActionHelpers.GetMousePosition()), float.PositiveInfinity, ActionHelpers.LayerArrayToLayerMask(this.layerMask, this.invertMask.Value));
