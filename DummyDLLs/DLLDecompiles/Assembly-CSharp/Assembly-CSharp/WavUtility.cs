...
{
	// Token: 0x060009E0 RID: 2528 RVA: 0x0002CB24 File Offset: 0x0002AD24
	public static void WriteWavFile(AudioClip clip, string filePath)
	{
		float[] array = new float[clip.samples * clip.channels];
		clip.GetData(array, 0);
		using (FileStream fileStream = WavUtility.CreateEmptyWavFile(filePath, clip.samples, clip.channels, clip.frequency))
		{
			WavUtility.ConvertAndWrite(fileStream, array);
			WavUtility.WriteHeader(fileStream, clip);
		}
	}

	// Token: 0x060009E1 RID: 2529 RVA: 0x0002CB90 File Offset: 0x0002AD90
	...
	// Token: 0x060009E2 RID: 2530 RVA: 0x0002CBB8 File Offset: 0x0002ADB8
	...
	// Token: 0x060009E3 RID: 2531 RVA: 0x0002CC04 File Offset: 0x0002AE04
